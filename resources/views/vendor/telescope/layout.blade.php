...
{{-- ── Telescope Extender ────────────────────────────────────────────────────
     Adds the "User" column to the Requests list without touching any vendor
     files. Source: public/js/telescope-ext.js
──────────────────────────────────────────────────────────────────────────── --}}
<script src="{{ asset('js/telescope-ext.js') }}?v={{ filemtime(public_path('js/telescope-ext.js')) }}"></script>
